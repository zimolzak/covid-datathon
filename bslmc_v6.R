...
earth.mod = earth(los.days.n ~ ., data = learning_data, nfold=10, keepxy=TRUE)
evimp(earth.mod)
summary(earth.mod)
...
earth.mod2 = earth(los.days.n ~ ., data = learning_data, degree=2, nfold=10, keepxy=TRUE)
evimp(earth.mod2)
summary(earth.mod2)
...
earth.mort1 = earth(died_ever ~ ., data = learning_data_mort, nfold=10, keepxy=TRUE)
evimp(earth.mort1)
summary(earth.mort1)

say('MARS model, mortality, degree 2')
earth.mort2 = earth(died_ever ~ ., data = learning_data_mort, degree=2, nfold=10, keepxy=TRUE)
evimp(earth.mort2)
summary(earth.mort2)
